# Generated by Django 3.0.3 on 2020-03-05 09:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping', models.IntegerField(default=1, null=True)),
                ...
                ('orderuser', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='orderuser', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created'],
            },
