...
def chartt(request):
    ...
    janM = daily.objects.filter(owner=request.user, created__range=["2020-01-01", "2020-01-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    febM = daily.objects.filter(owner=request.user, created__range=["2020-02-01", "2020-02-29"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    marM = daily.objects.filter(owner=request.user, created__range=["2020-03-01", "2020-03-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    aprM = daily.objects.filter(owner=request.user, created__range=["2020-04-01", "2020-04-30"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    mayM = daily.objects.filter(owner=request.user, created__range=["2020-05-01", "2020-05-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    junM = daily.objects.filter(owner=request.user, created__range=["2020-06-01", "2020-06-30"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    julM = daily.objects.filter(owner=request.user, created__range=["2020-07-01", "2020-07-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    augM = daily.objects.filter(owner=request.user, created__range=["2020-08-01", "2020-08-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    sepM = daily.objects.filter(owner=request.user, created__range=["2020-09-01", "2020-09-30"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    octM = daily.objects.filter(owner=request.user, created__range=["2020-10-01", "2020-10-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    novM = daily.objects.filter(owner=request.user, created__range=["2020-11-01", "2020-11-30"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))
    decM = daily.objects.filter(owner=request.user, created__range=["2020-12-01", "2020-12-31"]).aggregate(Avg('foodamount'), Avg('snackcount'), Avg('walkcount'))

    # 전체 평균
    janMA = daily.objects.filter(created__range=["2020-01-01", "2020-01-31"]).aggregate(Avg('walkcount'))
    febMA = daily.objects.filter(created__range=["2020-02-01", "2020-02-29"]).aggregate(Avg('walkcount'))
    marMA = daily.objects.filter(created__range=["2020-03-01", "2020-03-31"]).aggregate(Avg('walkcount'))
    aprMA = daily.objects.filter(created__range=["2020-04-01", "2020-04-30"]).aggregate(Avg('walkcount'))
    mayMA = daily.objects.filter(created__range=["2020-05-01", "2020-05-31"]).aggregate(Avg('walkcount'))
    junMA = daily.objects.filter(created__range=["2020-06-01", "2020-06-30"]).aggregate(Avg('walkcount'))
    julMA = daily.objects.filter(created__range=["2020-07-01", "2020-07-31"]).aggregate(Avg('walkcount'))
    augMA = daily.objects.filter(created__range=["2020-08-01", "2020-08-31"]).aggregate(Avg('walkcount'))
    sepMA = daily.objects.filter(created__range=["2020-09-01", "2020-09-30"]).aggregate(Avg('walkcount'))
    octMA = daily.objects.filter(created__range=["2020-10-01", "2020-10-31"]).aggregate(Avg('walkcount'))
    novMA = daily.objects.filter(created__range=["2020-11-01", "2020-11-30"]).aggregate(Avg('walkcount'))
    decMA = daily.objects.filter(created__range=["2020-12-01", "2020-12-31"]).aggregate(Avg('walkcount'))
